...
export function Installation() {
  ...
  return (
    <StepCard step={1} title="Instalação" id="instalacao">
      <p style={{ fontSize: "14px", color: "#666663" }}>
      ...
      <div>
          ...
          {(["macos", "universal"] as const).map((t) => (
            <button
              ...
              style={{
                ...
                color: tab === t ? "#E8E8E5" : "#5A5A57",
                borderBottom: tab === t ? "2px solid #FEE340" : "2px solid transparent",
                marginBottom: "-1px",
        ...
        {tab === "macos" && (
          <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            <p style={{ fontSize: "14px", color: "#5A5A57" }}>
